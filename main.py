...
SAMPLING_STRATEGY = 1  # 1: Use all data, 2: Undersample to min_class_size
...
for idx, (metric_key, metric_name) in enumerate(zip(metrics_to_plot, metric_names)):
    ...
    axes[idx].set_title(f'Boxplot of {metric_name} distributions of each model across {N_F} CV tests')
